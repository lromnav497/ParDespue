...
const Header = () => {
  ...
  const iconCar = "/icons/car.svg";

  return (
    <>
      {/* Carro animado: cruza de izquierda a derecha por arriba del header cada 2 minutos */}
      <img
        src={iconCar}
        alt="Car"
        className="fixed left-[-120px] top-2 w-24 h-12 z-[9999] animate-car-move-header pointer-events-none select-none"
        style={{ animationDelay: "0s" }}
      />
      {/* Carro animado: cruza de derecha a izquierda por abajo del header cada 2 minutos */}
      <img
        src={iconCar}
        alt="Car"
        className="fixed right-[-120px] bottom-2 w-24 h-12 z-[9999] animate-car-move-header-reverse pointer-events-none select-none"
        style={{ animationDelay: "60s", transform: "scaleX(-1)" }}
      />
      ...
      <style>
        {`
          ...
          .animate-car-move-header {
            animation: car-move-header 120s linear infinite;
          }
          .animate-car-move-header-reverse {
            animation: car-move-header-reverse 120s linear infinite;
          }
          @keyframes car-move-header {
            0% { left: -120px; opacity: 0; }
            1% { opacity: 1; }
            95% { opacity: 1; }
            100% { left: 100vw; opacity: 0; }
          }
          @keyframes car-move-header-reverse {
